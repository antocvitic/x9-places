...
public class Deleter extends HttpServlet{
	...
	public class Emailtoken extends TimerTask {
		...
		public void run() {
			...
			System.out.println("Sending email: " + tolink + "to email: " + toemail);
			timer.cancel();
		}
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		//Save confirmtoken to db, since it will be read only in 12+ hours to confirm deletion request.
		...
		String confirmlink = "http://localhost:8080/"+req.getContextPath()+"/user/delete?confirm_del="+confirmtoken;
