...
<div id="footer">
    ...
    <p>Some links: <a href="${pageContext.request.contextPath}/venue/view.jsp">venue/view.jsp</a> |
    <a href="${pageContext.request.contextPath}/venue/edit.jsp">venue/edit.jsp</a> | 
