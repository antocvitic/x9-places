...
<h:header title="Spot X9 - The X9 Team"></h:header>
<h:headercontent />
...
<h1>The X9 Team</h1>
<br />
<h5>The X9 Team is a group of nine people which was formed during
the KTH course <a
    href="http://www.csc.kth.se/utbildning/kth/kurser/DD1365/mvk09/">mvk09</a>.<br />
</h5>
<br />
<center>
<table border="0" cellspacing="8" style="font-size: smaller;">
    <tr>
        <th>Member</th>
        <th>Role</th>
    </tr>
...
<br />
<h5>We are a friendly bunch of computer science students and this
website is our project.</h5>
