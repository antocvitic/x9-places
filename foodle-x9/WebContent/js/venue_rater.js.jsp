...
function fixStars(venueID) {
    ...
    for (i = 1; i <= 6; i++) {
        if (i <= avgRating)
            $("#venue_rating_star_"+venueID+"_"+i).attr("src", "../images/stars/star-gold48.png");
        else
            $("#venue_rating_star_"+venueID+"_"+i).attr("src", "../images/stars/star-white48.png");
    }
}
...
$(document).ready(function() {
    ...
    $(".venue_rating_editable").click(function() {
        ...
        $.post("${pageContext.request.contextPath}/venue/rate", { venueID: venueID, rating: rating }, function(data){
            if (data.status == "ok") {
    ...
    $(".venue_rating_editable").hover(function () {
        ...
        for (i = 1; i <= this.title; i++) {
            $("#venue_rating_star_"+venueID+"_"+i).attr("src", "../images/stars/star-purple48.png");
        }
    }, function () {
        var venueID = $(this).parent().parent().data("venueID");
        fixStars(venueID);
