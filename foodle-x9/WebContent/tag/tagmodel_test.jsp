...
<form action="${pageContext.request.contextPath}/tag/edit"
    method="POST"><input name="redirect" type="hidden"
    value="${pageContext.request.contextPath}/tag/tagmodel_test.jsp?ok" />
<table class="content_block">
    ...
    <tr>
        <td><textarea class="editfield" name="tags"
            id="tags"></textarea></td>
    </tr>
    <tr>
