...
public class VenueModel {
	...
	public static class Validator {
		...
		public static final int VENUE_TITLE_MAX_LENGTH = 56;
		public static final int VENUE_ADDRESS_MAX_LENGTH = 256;
		public static final int VENUE_DESCRIPTION_MAX_LENGTH = 256;
		...
		public static void validateDescription(VenueModel venue)
			...
			if (venue.description.length() > VENUE_DESCRIPTION_MAX_LENGTH) {
